...
def cracformer(Input_shape = None,number_classes=None):
    num_blocks = [2, 2, 2, 2, 2]            # L
    channels = [64, 96, 192, 384, 768]      # D
    return CRACformer(Input_shape, 3, num_blocks, channels, num_classes=number_classes)
